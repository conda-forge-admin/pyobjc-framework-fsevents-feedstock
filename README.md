...
pixi add pyobjc-framework-fsevents
# for installing globally
pixi global install pyobjc-framework-fsevents
```
...
It is possible to list all of the versions of `pyobjc-framework-fsevents` available on your platform:
...
```
pixi search pyobjc-framework-fsevents --channel conda-forge
```
